...
def currency_rates(*args):
    ...
    Dates_curs=datetime.datetime(year=int(Dates_curs.split('.')[2]),month=int(Dates_curs.split('.')[1]),day=int(Dates_curs.split('.')[0]))
...
currency_rates("usd","Usd","usD", "eur", "KZT", "GBP")
